...
import { Link as LinkIcon, Megaphone, Plus, Eye, EyeOff } from "lucide-react";
...
const handleSubmit = (e: React.FormEvent) => {
  ...
  // ✅ Don't submit yet — just open the modal
  setShowModal(true);
};

const handleFinalSubmit = async () => {
  if (!modalData.Businesscategory || !modalData.description) {
...
console.log(payload)
  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 h-screen">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="flex flex-col">
              ...
              <input
                ...
                className={`${inter.className} border border-[#5E3345] rounded-lg px-4 py-2 focus:outline-none focus:ring-2 focus:ring-[#843163] text-black`}
                required
              />
            </div>
            ...
            <div className="space-y-2 mb-2">
              {socialLinks.map((s) => {
                ...
                return (
                  <div
                    key={s.id}
                    className="flex items-center justify-between border border-[#5E3345] rounded-lg px-3 py-2"
                  >
              ...
              <div className="relative flex w-full border border-[#5E3345] rounded-lg focus-within:ring-2 focus-within:ring-[#843163]">
                <div ref={ddRef} className="relative">
                  <button
                    ...
                    className="px-3 py-3 bg-[#E6D8DF] border-r border-[#5E3345] flex items-center gap-1 rounded-l-lg"
                  ...
                  {isOpen && (
                    <div
                      role="listbox"
                      className="absolute left-0 top-[calc(100%+4px)] min-w-[60px] bg-white border rounded-md shadow z-20"
                    >
                      {socials
                        ...
                        .map((s) => (
                          <button
                            ...
                            className="w-full p-2 hover:bg-gray-100 flex items-center justify-center gap-2 text-gray-700"
                            onClick={() => {
                              setSelected(s.id);
                              setIsOpen(false);
                            }}
                ...
                <input
                  ...
                  className={`${inter.className} flex-1 px-3 py-2 outline-none text-black`}
                />
                ...
                <button
                  ...
                  disabled={!usernameInput.trim() || socialLinks.length >= 3}
                  className={`px-4 flex items-center justify-center text-black font-bold rounded-r-lg ${
      ...
      <Modal isOpen={showModal} onClose={() => setShowModal(false)} title="More Info">
  <div className="flex flex-col gap-6">
    {/* Business Category */}
    <div className="flex flex-col">
      <label htmlFor="category" className={`${inter.className} font-medium text-black mb-1`}>
        Business Category
      </label>
      <select
        id="category"
        value={modalData.Businesscategory || ""}
        onChange={(e) => setModalData({ ...modalData, Businesscategory: e.target.value })}
        className={`${inter.className} border px-3 py-2 rounded bg-[#C7B5C8] text-black focus:outline-none focus:ring-2 focus:ring-[#843163]`}
      >
    ...
    <div className="flex flex-col">
      ...
      <textarea
        ...
        className="border px-3 py-2 rounded resize-none text-black focus:outline-none focus:ring-2 focus:ring-[#843163]"
    ...
    <div className="flex justify-center">
      <button
        ...
        disabled={isSubmitting}
        className={`${inter.className} bg-[#823A5E] text-white py-2 px-10 rounded-2xl font-medium hover:bg-[#6b264f] disabled:opacity-50`}
      >
