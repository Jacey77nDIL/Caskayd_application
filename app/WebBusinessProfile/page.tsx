...
// API
import { getCurrentUser } from "@/utils/api"; // Using generic for now, or create getBusinessProfile
...
export default function WebBusinessProfile() {
    ...
    async function loadProfile() {
      ...
      if (res.success && res.data) {
        setFormData({
          ...
          bio: res.data.bio || "", // Assuming backend sends 'bio' or 'description'
          image: res.data.image || "/images/profile.jpg",
        });
      }
      setLoading(false);
    }
  ...
  const handleSave = async (e: React.FormEvent) => {
    ...
    // TODO: Connect to actual Business Update Endpoint
    ...
    <div className="min-h-screen bg-gray-50 p-4 md:p-8">
      ...
      <div className="max-w-2xl mx-auto">
        ...
        <div className="flex items-center gap-4 mb-8">
          <button aria-label="Go back" onClick={() => router.back()} className="p-2 bg-white rounded-full hover:bg-gray-100 transition">
        ...
        <form onSubmit={handleSave} className="bg-white rounded-2xl shadow-sm border border-gray-200 p-6 md:p-8">
          ...
          <div className="flex flex-col items-center mb-8">
            ...
            <p className="text-sm text-gray-500">Tap to update Logo</p>
          </div>
          ...
          <div className="space-y-6">
            ...
            <div>
              <label className="block text-sm font-semibold text-gray-700 mb-2">About Business</label>
              <textarea
                name="bio"
                value={formData.bio}
                onChange={handleChange}
